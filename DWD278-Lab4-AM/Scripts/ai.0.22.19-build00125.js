...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        var Serializer = (function () {
            ...
            Serializer._serializeObject = function (State, name) {
                ...
                if (State[circularReferenceCheck]) {
                ...
                if (!State.aiDataContract) {
                    if (name === "measurements") {
                        output = Serializer._serializeStringMap(State, "number", name);
                    }
                    else if (name === "properties") {
                        output = Serializer._serializeStringMap(State, "string", name);
                    }
                    else if (name === "tags") {
                        output = Serializer._serializeStringMap(State, "string", name);
                    }
                    else if (ApplicationInsights.Util.isArray(State)) {
                        output = Serializer._serializeArray(State, name);
                    }
                    else {
                ...
                State[circularReferenceCheck] = true;
                for (var field in State.aiDataContract) {
                    var contract = State.aiDataContract[field];
                    ...
                    var isPresent = State[field] !== undefined;
                    var isObject = typeof State[field] === "object" && State[field] !== null;
                    if (isRequired && !isPresent && !isArray) {
                        ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_MissingRequiredFieldSpecification, "Missing required field specification. The field is required but not present on State", { field: field, name: name }));
                        continue;
                    }
                    if (isHidden) {
                        continue;
                    ...
                    if (isObject) {
                        if (isArray) {
                            value = Serializer._serializeArray(State[field], field);
                        }
                        else {
                            value = Serializer._serializeObject(State[field], field);
                        }
                    }
                    else {
                        value = State[field];
                ...
                delete State[circularReferenceCheck];
                return output;
            };
            Serializer._serializeArray = function (States, name) {
                var output = undefined;
                if (!!States) {
                    if (!ApplicationInsights.Util.isArray(States)) {
                        ...
                        for (var i = 0; i < States.length; i++) {
                            var State = States[i];
                            var item = Serializer._serializeObject(State, name + "[" + i + "]");
                            output.push(item);
                        }
                    }
                }
...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            ...
            this.operationSyntheticState = "ai.operation.syntheticState";
            ...
            this.internalRequestState = "ai.internal.requestState";
            this.internalFlowType = "ai.internal.flowType";
            this.internalIsAudit = "ai.internal.isAudit";
            this.internalTrackingStateId = "ai.internal.trackingStateId";
        ...
        var TelemetryContext = (function () {
            ...
            TelemetryContext.prototype._applyOperationContext = function (envelope, operationContext) {
                if (operationContext) {
                    ...
                    if (typeof operationContext.syntheticState === "string") {
                        envelope.tags[tagKeys.operationSyntheticState] = operationContext.syntheticState;
                    }
                }
            };
...
(function (AI) {
    "use strict";
    (function (DependencyStateType) {
        DependencyStateType[DependencyStateType["Undefined"] = 0] = "Undefined";
        DependencyStateType[DependencyStateType["Aic"] = 1] = "Aic";
        DependencyStateType[DependencyStateType["Apmc"] = 2] = "Apmc";
    })(AI.DependencyStateType || (AI.DependencyStateType = {}));
    var DependencyStateType = AI.DependencyStateType;
})(AI || (AI = {}));
/// <reference path="Domain.ts" />
/// <reference path="DataPointType.ts" />
/// <reference path="DependencyKind.ts" />
/// <reference path="DependencyStateType.ts" />
var AI;
(function (AI) {
    "use strict";
    var RemoteDependencyData = (function (_super) {
        ...
        function RemoteDependencyData() {
            ...
            this.success = true;
            this.dependencyState = AI.DependencyStateType.Apmc;
            this.properties = {};
            _super.call(this);
        }
            ...
            var RemoteDependencyData = (function (_super) {
                ...
                function RemoteDependencyData(id, absoluteUrl, commandName, value, success, resultCode, method) {
                    ...
                    this.aiDataContract = {
                        ...
                        dependencyState: ApplicationInsights.FieldType.Default,
